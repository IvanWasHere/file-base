...
- **Amended again (2026-09-23): nothing but the user reveals the preview.** Selecting a file no longer opens the panel either; it opens and closes only through the toolbar's Toggle preview button, Space, and View → Show Preview. The selection-transition effect in `ExplorerPane` is gone, and with it the Photos side effect noted under M13.
