...
export function PreviewPanel({ item }: { item: FileItem | null }) {
  ...
  return (
    <aside
      aria-label="Preview"
      className="bg-base border-edge flex w-[280px] shrink-0 flex-col overflow-hidden border-l"
    >
      <div className="border-edge text-secondary flex items-center justify-between border-b px-3 py-2.5 text-xs font-semibold">
        <span>Preview</span>
        <button
          type="button"
